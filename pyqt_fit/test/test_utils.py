...
class TestNamedTuple(object):
    ...
    def test_badname(self):
        nt = utils.namedtuple('nt', 'x y _test1')

    @raises(ValueError)
    def reserved(self, n):
        nt = utils.namedtuple('nt', n)
    ...
    def test_keyword(self):
        nt = utils.namedtuple('nt', 'is')

    @raises(ValueError)
    def test_duplicate(self):
        nt = utils.namedtuple('nt', 'x y x')

    @raises(ValueError)
    def test_number(self):
        nt = utils.namedtuple('nt', 'x 12 x')

    @raises(ValueError)
    def test_symbol(self):
        nt = utils.namedtuple('nt', 'x y-t x')
