...
def epanechnikov_pdf(np.ndarray z, object out = None):
...
def epanechnikov_cdf(np.ndarray z, object out = None):
...
def epanechnikov_pm1(np.ndarray z, object out = None):
...
def epanechnikov_pm2(np.ndarray z, object out = None):
...
def epanechnikov_o4_pdf(np.ndarray z, object out = None):
...
def epanechnikov_o4_cdf(np.ndarray z, object out = None):
...
def epanechnikov_o4_pm1(np.ndarray z, object out = None):
